...
public class assignment61 {
    ...
    public static void incrementCount(Address contractAddress){
        ...
        Result result= Blockchain.call(contractAddress,
        ...
        count++;
        Blockchain.println(
                "The owner address is "+ownerAddress);
        Blockchain.println(
                "The caller address is "+ Blockchain.getCaller());
        Blockchain.println(
                "The Count after Increment is "+count);
    }
}
